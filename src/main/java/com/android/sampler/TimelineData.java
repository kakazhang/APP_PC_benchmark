...
public class TimelineData {
  ...
  public TimelineData(int streams, int capacity, SampleTransform transform) {
    mCapacity = capacity;
  ...
  public synchronized void addStream( String id) {
  ...
  public synchronized void addStreams(List<String> ids) {
    for (String id : ids) {
      addStream(id);
    }
  }

  public synchronized void removeStream(String id) {
  ...
  private int getStreamIndex(String id) {
    int indexToReturn = -1;
  ...
  public synchronized void removeStreams(List<String> ids) {
    for (String id : ids) {
      removeStream(id);
    }
  }
  ...
  public static class Stream {
    ...
    public Stream(String id, int maxValueSize, int startSize) {
      mId = id;
